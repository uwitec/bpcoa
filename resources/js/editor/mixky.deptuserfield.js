...
Mixky.editor.DeptUserField = Ext.extend(Mixky.editor.PanelTriggerField, {
    ...
    renderPanel : function(el){
		...
		var tree = new Ext.tree.TreePanel({
	        ...
	        loader: new Ext.tree.TreeLoader({
	            directFn: OrganizationAppDirect.getDeptUserTree,
	            paramOrder : ['type'],
	        	baseParams : {type:''},
...
Ext.reg('mixkydeptuserfield', Mixky.editor.DeptUserField);