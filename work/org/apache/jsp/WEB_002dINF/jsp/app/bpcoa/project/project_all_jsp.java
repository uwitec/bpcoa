 ...
 * Generated at: 2013-02-20 02:21:47 UTC
...
public final class project_all_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(ViewManager.instance().isViewHasQuery(view)){
      ...
      out.write("\t\tMixkyApp.desktop.openDocument('bpcProject.docProject', id);\r\n");
      out.write("\t}\r\n");
      out.write("}});\r\n");
      out.write("\r\n");
      out.write("\tvar btnMerge =  new Ext.Action({\"text\":\"合并项目\",\"iconCls\":\"icon-app-bpcoa-project-merge\",\"handler\":function(){\r\n");
      out.write("\tvar records = grid.getSelectedRecords();\r\n");
      out.write("var id = records[0].get('ID');\r\n");
      out.write("var title = records[0].get(\"F_TITLE\");\r\n");
      out.write("\tif(id > 0){\r\n");
      out.write("\t\tvar projectpanel = new Ext.Panel({\r\n");
      out.write("\t\t\tid : 'pnl-project-list',\r\n");
      out.write("\t\t\tlayout : 'fit',\r\n");
      out.write("\t\t\tautoLoad : {\r\n");
      out.write("\t\t\t\turl : 'page.do',\r\n");
      out.write("\t\t\t\tparams : {url:'app/bpcoa/project/project.merge',projectid:id,projecttitle:title,panelid:'");
      out.print(panelid);
      out.write("'},\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\tvar projectwin = new Ext.Window({\r\n");
      out.write("\t\tmodal: true,\r\n");
      ...
      out.write("\t\titems: projectpanel,\r\n");
      out.write("\t\tbuttons : [{\r\n");
      out.write("\t\t\ttext : '合并',\r\n");
      out.write("\t\t\ticonCls : 'icon-sys-confirm',\r\n");
      out.write("\t\t\thandler : function(){\r\n");
      out.write("\t\t\t\tvar result = projectpanel.check();\r\n");
      out.write("\t\t\t\tif(result!=0) return;\r\n");
      out.write("\t\t\t\tprojectwin.close();\r\n");
      out.write("\t\t\t\tpanel.refresh();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}, \r\n");
      out.write("\t\t{\r\n");
      ...
      out.write("\t\t}]\r\n");
      out.write("\t});\r\n");
      out.write("\tprojectwin.show();\r\n");
      out.write("\t}\r\n");
      out.write("}});\r\n");
      out.write("\r\n");
      out.write("\tvar btnImport =  new Mixky.plugins.UploadButton({\"text\":\"模板导入\",\"iconCls\":\"icon-sys-btnimport\",\"uploadConfig\":{\r\n");
      out.write("    file_types: '*.xls;*.xlsx',\r\n");
      out.write("\tupload_url : 'servlet/app/bpcproject.import',\r\n");
      out.write("\tpost_params : {\r\n");
      out.write("\t\tcolumNumber: 23,\r\n");
      ...
      out.write(";\r\n");
      out.write("\tvar buttons = [\"->\",btnOpen,btnMerge,btnImport,\"-\",quickQueryField,btnQuickQuery,\"-\",btnAdvanceQueryButton,\"-\",btnRefresh];\r\n");
