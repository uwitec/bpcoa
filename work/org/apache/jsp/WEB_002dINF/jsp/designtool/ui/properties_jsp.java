...
public final class properties_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String mclass = request.getParameter("mclass");
      ...
      out.write("\t\t\tif(Ext.isDefined(p.xconfig) && p.xconfig.selectInParent){\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tDesignToolDirect.saveObject(pgrid.key, commit, function(result, e){\r\n");
      ...
      out.write("\t};\r\n");
      out.write("\t// 重新装载属性数据\r\n");
      out.write("\tpanel.loadPropertiesData = function(){\r\n");
      out.write("\t\tDesignToolDirect.loadObject(key, function(result, e){\r\n");
      ...
      out.write("\t\tvar modifieds = store.getModifiedRecords();\r\n");
      out.write("\t\tif(modifieds.length > 0){\r\n");
      out.write("\t\t\tExt.MessageBox.confirm('操作提示', '刷新操作将放弃尚未保存的修改，您确定吗？', function(btn){\r\n");
