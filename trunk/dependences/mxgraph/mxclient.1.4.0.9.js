...
var mxUtils = {
    ...
    repaintGraph: function (graph, pt) {
        ...
        if (c != null && pt != null && (mxClient.IS_GC || false || false) && (c.scrollLeft > 0 || c.scrollTop > 0)) {
    ...
    addMouseWheelListener: function (funct) {
        if (funct != null) {
            var wheelHandler = function (evt) {
                ...
                var delta = 0;
                if (mxClient.IS_NS && !false && !mxClient.IS_GC) {
                    delta = -evt.detail / 2;
                } else {
            ...
            if (mxClient.IS_NS) {
                var eventName = (false || mxClient.IS_GC) ? 'mousewheel' : 'DOMMouseScroll';
...
mxText.prototype.create = function (container) {
    ...
    if (this.dialect == mxConstants.DIALECT_SVG) {
        ...
        if (mxClient.IS_NS && !mxClient.NO_FO) {
...
mxImageShape.prototype.create = function () {
    ...
    if (this.dialect == mxConstants.DIALECT_SVG) {
        ...
        if (this.dialect == mxConstants.DIALECT_STRICTHTML || this.dialect == mxConstants.DIALECT_PREFERHTML) {
            ...
            if (imgName.substring(imgName.length - 3, imgName.length) == "PNG" && mxClient.IS_IE6) {
...
mxGraphView.prototype.installListeners = function () {
    ...
    if (container != null) {
        ...
        mxEvent.addListener(container, md, mxUtils.bind(this, function (evt) {
            ...
            if (this.isContainerEvent(evt) && ((!mxClient.IS_IE && !mxClient.IS_GC && !false && !false) || !this.isScrollEvent(evt))) {
...
mxGraph.prototype.fireMouseEvent = function (evtName, me, sender) {
    ...
    if ((evtName != mxEvent.MOUSE_UP || this.isMouseDown) && me.getEvent().detail != 2) {
        ...
        if (!this.isEditing() && (false || false || mxClient.IS_GC || me.getEvent().target != this.container)) {
...
mxRubberband.prototype.mouseDown = function (sender, me) {
    if (!me.isConsumed() && this.isEnabled() && this.graph.isEnabled() && (this.graph.isForceMarqueeEvent(me.getEvent()) || me.getState() == null)) {
        ...
        var mm = (mxClient.IS_TOUCH) ? 'touchmove' : 'mousemove';
        var mu = (mxClient.IS_TOUCH) ? 'touchend' : 'mouseup';
        mxEvent.addListener(document, mm, this.dragHandler);
        mxEvent.addListener(document, mu, this.dropHandler);
        me.consume(false);
    }
};
...
mxRubberband.prototype.reset = function () {
    ...
    if (this.dragHandler != null) {
        mxEvent.removeListener(document, mm, this.dragHandler);
        this.dragHandler = null;
    }
    if (this.dropHandler != null) {
        mxEvent.removeListener(document, mu, this.dropHandler);
...
mxEdgeHandler.prototype.mouseDown = function (sender, me) {
    var handle = null;
    if (mxClient.IS_NS || me.getState() == this.state) {
...
if (mxClient.IS_NS && !mxClient.IS_GC && !false) {
