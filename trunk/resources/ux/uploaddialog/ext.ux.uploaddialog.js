...
p.i18n = {
  ...
  note_col_width: 150,
  add_btn_text: '添加',
  add_btn_tip: '添加文件到上传队列中.',
  remove_btn_text: '移除',
  remove_btn_tip: '从队列中删除文件.',
  reset_btn_text: '重置',
  reset_btn_tip: '重置队列.',
  upload_btn_start_text: '上传',
  upload_btn_stop_text: '退出',
  upload_btn_start_tip: '上传队列中的文件到服务器.',
  upload_btn_stop_tip: '停止上传.',
  close_btn_text: '关闭',
  close_btn_tip: '关闭窗口.',
  progress_waiting_text: '等待...',
  progress_uploading_text: '上传中: {0} of {1} 文件上传完毕.',
  error_msgbox_title: '错误',
  permitted_extensions_join_str: ',',
  err_file_type_not_permitted: '所选的文件类型不正确.<br/>选择文件的扩展名必须是: {1}',
  note_queued_to_upload: '已上传完毕的队列.',
  note_processing: '上传...',
  note_upload_failed: '服务器端发生错误.',
