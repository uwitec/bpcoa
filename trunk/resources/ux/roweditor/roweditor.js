    ...
    startEditing: function(rowIndex, doFocus){
        ...
        if(this.fireEvent('beforeedit', this, rowIndex) !== false){
            ...
            for(var i = 0, len = cm.getColumnCount(); i < len; i++){
                ...
                f = fields[i];
            	// f.setValue(val);
                // add by zhangchang 处理域值初始化
                if(this.fireEvent('beforesfieldsetvalue', f, val, record, g, row, i) !== false){
                	f.setValue(val);
                }
                // update by zhangchang 2009-09-07 采用数字编辑框时校验修改有误
