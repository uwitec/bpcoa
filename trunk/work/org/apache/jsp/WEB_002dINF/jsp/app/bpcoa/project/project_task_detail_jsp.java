 ...
 * Generated at: 2013-03-11 01:41:04 UTC
...
public final class project_task_detail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String panelid = request.getParameter("panelid");
      ...
      out.write("\t\t\t\tform. (panel.panel.refresh);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}, {\r\n");
      out.write("\t\t\ttext : '启动任务',\r\n");
      ...
      out.write("\t\t\thandler : function(){\r\n");
      out.write("\t\t\t\t//增加提示按钮\r\n");
      out.write("\t\t\t\tExt.Msg.confirm('关闭警告','关闭该任务将无法重新执行，您确定吗？',function(btn){\r\n");
      ...
      out.write("\t\t\t\t\t\t\t//alert(form.getTopToolbar().size());\r\n");
      out.write("\t\t\t\t\t\t\tform.getTopToolbar().get(1).show();\r\n");
      ...
      out.write("\t\t\t\t\t\t\tform.getTopToolbar().get(0).show();\r\n");
      out.write("\t\t\t\t\t\t\tform.getTopToolbar().get(2).show();\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\tbreak;\r\n");
      out.write("\t\t\t\t\tcase '完成': \r\n");
      out.write("\t\t\t\t\t\tif(result.isParentTaskManager){\r\n");
      out.write("\t\t\t\t\t\t\tform.getTopToolbar().get(3).show();\r\n");
      out.write("\t\t\t\t\t\t\tform.getTopToolbar().get(4).show();\r\n");
      ...
      out.write("\t\t// 屏蔽操作\r\n");
      out.write("\t\t//form.getTopToolbar().hide();\r\n");
      out.write("\t\tfor(var i = 0;i<5;i++){\r\n");
      out.write("\t\t\tform.getTopToolbar().get(i).hide();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t// 装载数据\r\n");
