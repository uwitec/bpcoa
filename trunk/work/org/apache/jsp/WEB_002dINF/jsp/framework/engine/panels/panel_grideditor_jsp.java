...
public final class panel_grideditor_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(view.getF_single_select()){
      ...
      out.write("            if(cm.getColumnById(k).getEditor() != null){\r\n");
      ...
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tif(Ext.isDefined(ed.valueFieldName)){\r\n");
      out.write("\t\t\t\t\tchanges[ed.valueFieldName] = ed.realValue;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tif(config){\r\n");
      out.write("\t\t\t\tfor(n in config){\r\n");
      out.write("\t\t\t\t\trecord.set(n, config[n]);\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t// 添加复制行\r\n");
      out.write("\tpanel.copyRecord = function(){\r\n");
      out.write("\t\tif(roweditor.editing){\r\n");
      out.write("\t\t\tMixkyApp.showAlertMessage(\"无法拷贝，请关闭编辑界面\");\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tvar cm = grid.getSelectionModel();\r\n");
      out.write("\t\tvar record = cm.getSelected();\r\n");
      out.write("\t\tif(!record){\r\n");
      out.write("\t\t\tMixkyApp.showAlertMessage(\"无法拷贝，未选中复制行\");\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tMixky.lib.getNewTableRecordId('");
      out.print(tableform.getParent().getF_key());
      out.write("', function(newId){\r\n");
      out.write("\t\t\tvar newrec = new store.recordType({ID : newId, rowstate : 'add'}, newId);\r\n");
      out.write("\t\t\tvar index = store.getCount();\r\n");
      out.write("\t\t\tstore.insert(index, newrec);\r\n");
      out.write("\r\n");
      out.write("\t\t\tfor (var key in record.data) {\r\n");
      out.write("\t\t\t\tif (key != 'ID') {\r\n");
      out.write("\t\t\t\t\tnewrec.set(key, record.data[key]);\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(orderable){\r\n");
      out.write("\t\t\t\tnewrec.set('F_ORDER', index + 1);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tgrid.getSelectionModel().selectRow(index);\r\n");
      out.write("\t\t\t//var newrec = record.copy();\r\n");
      out.write("\t\t\t//newrec.set(\"ID\", newId);\r\n");
      out.write("\t\t\t//newrec.set(\"rowstate\", 'add');\r\n");
      out.write("\t\t\t//if(orderable){\r\n");
      out.write("\t\t\t\t//newrec.set('F_ORDER', index + 1);\r\n");
      out.write("\t\t\t//}\r\n");
      out.write("\t\t\t//store.add(newrec);\r\n");
      out.write("\t\t\t//grid.getSelectionModel().selectRow(store.getCount() - 1);\r\n");
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      out.write("\t// 删除\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tpanel.importDatas = function(url){\r\n");
      out.write("\t\tvar dialog = new Ext.ux.UploadDialog.Dialog({\r\n");
      out.write("\t\t\turl: url,\r\n");
      out.write("\t\t\tmodal : true,\r\n");
      out.write("\t\t\tmanager : MixkyApp.desktop.getManager(),\r\n");
      out.write("\t\t\treset_on_hide : false,\r\n");
      out.write("\t\t\tbase_params : {\r\n");
      out.write("\t\t\t\tdocumentid : panel.document.documentid\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\tallow_close_on_upload : true,\r\n");
      out.write("\t\t\tupload_autostart : true,\r\n");
      out.write("\t\t\tpost_var_name : 'upload'\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\tdialog.on('uploadsuccess', function(uploaddialog, filename, response) {\r\n");
      out.write("\t\t\tif (response.records) {\r\n");
      out.write("\t\t\t\t//var record = new store.recordType({ID : newId, rowstate : 'add'}, newId);\r\n");
      out.write("\t\t\t\tvar index = store.getCount();\r\n");
      out.write("\t\t\t\tfor (var i=0; i < response.records.length; i++) {\r\n");
      out.write("\t\t\t\t\tvar obj = response.records[i];\r\n");
      out.write("\t\t\t\t\tvar record = new store.recordType({ID : obj.ID, rowstate : 'add'}, obj.ID);\r\n");
      out.write("\t\t\t\t\tstore.insert(index, record);\r\n");
      out.write("\t\t\t\t\tfor (var key in obj) {\r\n");
      out.write("\t\t\t\t\t\tif (key != 'ID') {\r\n");
      out.write("\t\t\t\t\t\t\tstore.getAt(index).set(key, obj[key]);\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\tif(orderable){\r\n");
